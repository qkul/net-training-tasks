...
namespace IOStreams
{
	...
	public static class TestTasks
	{
		...
		public static IEnumerable<PlanetInfo> ReadPlanetInfoFromXlsx(string xlsxFileName)
		{
            ...
            //{
            //    var stringValues = package.GetPart(new Uri(@"/xl/sharedStrings.xml", UriKind.Relative));
            //    var mainWorksheet = package.GetPart(new Uri(@"/xl/worksheets/sheet1.xml", UriKind.Relative));
            //    var xDoc = XDocument.Load(package, stringValues);
